    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <header className="relative z-10 flex items-center justify-between px-4 sm:px-6 py-4 lg:px-12">
        <div className="flex items-center space-x-2 pl-3 sm:pl-6 lg:pl-12">
          <span className="text-white font-bold text-lg sm:text-xl lg:text-2xl">NeuroPix</span>
        </div>
      ...
      <main className="relative z-10 flex flex-col items-start justify-start sm:justify-center min-h-[calc(100vh-80px)] px-4 sm:px-6 lg:px-12 max-w-6xl pt-4 sm:-mt-12 lg:-mt-24 pl-6 sm:pl-12 lg:pl-20">
        ...
        <div className="mb-4 sm:mb-8">
          <div className="inline-flex items-center bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-3 sm:px-4 py-2">
            <span className="text-white text-xs md:text-xs">✦ Нейрофотография нового поколения</span>
          </div>
        </div>
        ...
        <p className="text-white/70 text-sm sm:text-base md:text-sm lg:text-2xl mb-6 sm:mb-8 max-w-2xl text-pretty">
          Нейрофотографии по вашим референсам, реставрация старых снимков
          <br className="hidden sm:block" />
          <span className="sm:hidden"> </span>
          и инфографика для маркетплейсов — всё с помощью ИИ.
        </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            <div className="group relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-orange-500/40 hover:bg-white/8 transition-all duration-300">
              ...
              <h3 className="text-white font-semibold text-lg mb-2">Портрет по референсу</h3>
              <p className="text-white/50 text-sm leading-relaxed">
                Загружаете фото или описание — получаете готовый нейропортрет в нужном стиле: реализм, фэнтези, аниме и другие.
              </p>
            </div>
            ...
            <div className="group relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-orange-500/40 hover:bg-white/8 transition-all duration-300">
              ...
              <h3 className="text-white font-semibold text-lg mb-2">Арт и концепт</h3>
              <p className="text-white/50 text-sm leading-relaxed">
                Персонажи, локации, обложки — создаю художественные образы для игр, книг, брендинга и творческих проектов.
              </p>
            </div>
            ...
            <div className="group relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-orange-500/40 hover:bg-white/8 transition-all duration-300">
              ...
              <h3 className="text-white font-semibold text-lg mb-2">Уникальный стиль</h3>
              <p className="text-white/50 text-sm leading-relaxed">
                Разрабатываю авторский визуальный стиль под ваш бренд или проект — чтобы образы были узнаваемы и неповторимы.
              </p>
            </div>
          </div>
